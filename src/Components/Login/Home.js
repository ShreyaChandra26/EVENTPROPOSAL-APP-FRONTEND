...
const Home = () => {
  ...
  const VendorLogin = async () => {
    const resp = await fetch("https://eventproposal-app-backend.onrender.com/vendorsignin", {
      method: "POST",
      headers: {
  ...
  const UserLogin = async () => {
    const response = await fetch("https://eventproposal-app-backend.onrender.com/usersignin", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
